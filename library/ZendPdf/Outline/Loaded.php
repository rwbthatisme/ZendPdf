...
class Loaded extends AbstractOutline
{
     ...
     * @internal
     */
    public function __construct(AbstractTypeObject $dictionary, SplObjectStorage $processedDictionaries = null)
    {
        ...
        if ($dictionary->Count !== null) {
            if ($dictionary->Count->getType() != AbstractTypeObject::TYPE_NUMERIC) {
    ...
    public function getColor()
    {
        ...
        return new Rgb($components[0], $components[1], $components[2]);
    }
    ...
    public function getTarget()
    {
        if ($this->_outlineDictionary->Dest !== null) {
            ...
            return AbstractAction::load($this->_outlineDictionary->A);
        }
    ...
    public function setTarget($target = null)
    {
        ...
        if ($target === null) {
            ...
            $this->_outlineDictionary->A = null;
        } elseif ($target instanceof AbstractAction) {
            $this->_outlineDictionary->Dest = null;
